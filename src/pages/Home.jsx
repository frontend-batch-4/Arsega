        ...
        <>
            ...
            <div className='flex flex-col items-center mt-1 md:flex-row  md:justify-around  '>
                ...
                <div className='flex justify- mt-5 flex-col items-center md:items-start md:order-1 order-2 md:ps-8  '>
                    ...
                    <NavLink
                        to="/katalog"
                        className="bg-[#3D55AC] rounded-lg hover:bg-blue-800 font-Montserrat font-extrabold px-3 py-2 text-white mb-4 md:p-4"
                    >
                        RENTAL SEKARANG
                    </NavLink>
            ...
            <div className=" mt-3 md:flex md:justify-between md:order-2 md:relative  ">
                <img src={money} className='h-30 object-contain items-center px-12 md:order-1 md:h-96 md:scale-125 md:px-0 md:relative md:-top-32' />
